...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addEvent(padding, 'change', melibu_colorpicker_set_pad);
    ...
    addEvent(borderRadius, 'change', melibu_colorpicker_set_rad);
    ...
    addEvent(borderWidth, 'change', melibu_colorpicker_set_wid);
    
    borderStyle = document.querySelector('.melibu-plugin-typing-border-style');
    addEvent(borderStyle, 'change', melibu_colorpicker_set_widsty);
});
