...
if (!class_exists('MELIBU_PLUGIN_FRONTEND_07')) {
    ...
    class MELIBU_PLUGIN_FRONTEND_07 {
        ...
        public function wp_enqueue_scripts() {
             ...
             */
            wp_enqueue_style('melibu-plugin-typing-css', plugins_url('css/style.min.css', dirname(__FILE__)));
             ...
             */
            wp_enqueue_script('melibu-plugin-typing-js', plugins_url('js/mb-typing.js', dirname(__FILE__)), '', '', true);
            wp_enqueue_script('melibu-plugin-typing-event-js', plugins_url('js/mb-event.js', dirname(__FILE__)), '', '', true);
        }
        ...
        public function shortcode($atts, $content = null) {
            ...
            $backturn  = '<section class="typing-letters">';
            $backturn .= '<div>' .  $content . '</div>';
            $backturn .= '</section>';
            $backturn .= '<span class="st_copy">';
            $backturn .= 'AutoTyper &copy; by';
            $backturn .= '<a href="http://samet-tarim.de/wp/melibu-plugins/auto-text-typing/" target="_blank">Melibu</a>';
            $backturn .= '</span>';
