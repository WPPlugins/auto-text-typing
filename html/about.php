...
<div class="melibu_typing_about wrap about-wrap">
    ...
    <h1>
        <?php _e('Welcome to', 'sharing-social-safe'); ?> <span style="color:#FF7F01;"><?php echo $datas['Name']; ?></span>&nbsp;v.<?php echo $datas['Version']; ?>
    </h1>
            ...
            <ul>
                <li class="st_melibuPlugin_list_item_1">
                    <div class="st_melibuPlugin_list_content">
                        ...
                        <hr />
                        <p>
                            <?php _e('More Professional', 'auto-text-typing'); ?> <a href="http://samet-tarim.de/wp/melibu-themes" target="_blank"><?php _e('Themes', 'auto-text-typing'); ?> </a> <?php _e('and ', 'auto-text-typing'); ?> <a href="http://samet-tarim.de/wp/melibu-plugins" target="_blank"><?php _e('Plugins', 'auto-text-typing'); ?> </a>
                        </p>
                        <hr />
                        <div class="headline-feature feature-video" style="background-color:#191E23;">
                            <img src="<?php echo plugins_url("screenshot-1.jpg", dirname(__FILE__)); ?>" alt="screenshot-1" width="650" class="st_img"/>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="feature-section two-col">
                            <div class="col">
                                ...
                                <ul>
                                    ...
                                    <li><span class="dashicons dashicons-thumbs-up"></span>
                                        <a href="https://www.facebook.com/wordpress.melibu/" target="_blank"><?php _e('Facebook Like', 'auto-text-typing'); ?></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col">
                    ...
                    <div class="st_melibuPlugin_list_content">
                        ...
                        <ul>
                            <li>
                                ...
                                <p>
                                    <?php _e('Founder and Project Manager', 'auto-text-typing'); ?><br />
                            ...
                            <li>
                                ...
                                <p>
                                    <?php _e('Economic Computer Science', 'auto-text-typing'); ?><br />
                ...
                <li class="st_melibuPlugin_list_item_5">
                    <div class="st_melibuPlugin_list_content">
                        ...
                        <hr />
                        <p>
                            <span class="dashicons dashicons-translation"></span> <?php _e('Translate this Plugin', 'auto-text-typing'); ?>: <a href="https://translate.wordpress.org/projects/wp-plugins/download-counter-button" target="_blank"><?php _e('Translate', 'auto-text-typing'); ?></a>
                        </p>
                        <hr />
                    </div>
                </li>
                <li class="st_melibuPlugin_list_item_6">
                    <div class="st_melibuPlugin_list_content">
                        ...
                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                            ...
                            <input type="image" src="https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="<?php _e('Now simply, quickly and safely pay online - with PayPal.', 'auto-text-typing'); ?>">
                        ...
                        <p>
                            <em><?php _e('Your Melibu Team', 'auto-text-typing'); ?></em>
                        </p>
                    </div>
                </li>
            </ul>
